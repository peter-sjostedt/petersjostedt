            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th><?= t('admin.organizations.table.contact') ?></th>
                        <th>
                ...
                <tbody>
                    <?php foreach ($organizations as $org): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($org['email']): ?>
                                    <?= htmlspecialchars($org['email']) ?><br>
                                <?php endif; ?>
                                <?php if ($org['phone']): ?>
                                    <small><?= htmlspecialchars($org['phone']) ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td class="actions">
                                <a href="units.php?org_id=<?= urlencode($org['id']) ?>" class="btn btn-primary btn-small">
                                    <?= t('admin.organizations.action.view_units') ?>
                                </a>
                                <button type="button" class="btn btn-secondary btn-small" data-org-edit='<?= json_encode($org) ?>'><?= t('admin.organizations.action.edit') ?></button>
                                <?php if ($org['id'] !== 'SYSTEM'): ?>
                                    <form method="POST" style="display:inline;" data-confirm="<?= t('admin.organizations.modal.delete.message', ['name' => htmlspecialchars($org['name'])]) ?>">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-small"><?= t('admin.organizations.action.delete') ?></button>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>
