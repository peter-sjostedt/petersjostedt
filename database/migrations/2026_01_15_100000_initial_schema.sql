-- Migration: 2026_01_15_100000_initial_schema.sql
-- Description: Skapar alla bastabeller för systemet
...
-- Users: Användare i systemet
CREATE TABLE users (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    email VARCHAR(255) NOT NULL UNIQUE,
    password VARCHAR(255) NOT NULL,
    name VARCHAR(100) NOT NULL,
    role ENUM('admin', 'org_admin', 'user') NOT NULL DEFAULT 'user' COMMENT 'admin=system admin, org_admin=organization admin, user=basic user',
...
-- ==================================================
-- DOWN: Ingen rollback för initial_schema (detta är baslinjen)
-- ==================================================
